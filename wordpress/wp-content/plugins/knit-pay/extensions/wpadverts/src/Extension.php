...
class Extension extends AbstractPluginIntegration {
	...
	public static function status_update( Payment $payment ) {
		...
		switch ( $payment->get_status() ) {
			...
			case Core_Statuses::EXPIRED:
				...
				adext_payments_log( $payment_id, __( 'Payment Cancelled.', 'knit-pay' ) );
			...
			case Core_Statuses::FAILURE:
				...
				adext_payments_log( $payment_id, __( 'Payment failed.', 'knit-pay' ) );
			...
			case Core_Statuses::SUCCESS:
				...
				adext_payments_log( $payment_id, __( 'Payment successful.', 'knit-pay' ) );
			...
			case Core_Statuses::REFUNDED:
				...
				adext_payments_log( $payment_id, __( 'Payment Refunded.', 'knit-pay' ) );
	...
	public function source_text( $text, Payment $payment ) {
		$text = __( 'WP Adverts', 'knit-pay' ) . '<br />';
	...
	public function source_description( $description, Payment $payment ) {
		return __( 'WP Adverts Payment', 'knit-pay' );
	}
