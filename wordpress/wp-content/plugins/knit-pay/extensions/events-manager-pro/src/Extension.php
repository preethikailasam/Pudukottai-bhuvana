...
class Extension extends AbstractPluginIntegration {
	...
	public function __construct() {
		parent::__construct(
			array(
				'name' => __( 'Events Manager Pro', 'pronamic_ideal' ),
			)
		);
	...
	public function setup() {
		...
		add_action( 'em_gateways_init', array( $this, 'em_gateways_init' ) );
		add_filter( 'em_get_currencies', array( $this, 'em_get_currencies' ), 10, 1 );
	}
	...
	public function em_get_currencies( $currencies ) {
		$currencies->names        = array( 'INR' => __( 'INR - Indian Rupee', 'knit-pay' ) ) + $currencies->names;
		$currencies->symbols      = array( 'INR' => __( 'Rs.', 'knit-pay' ) ) + $currencies->symbols;
		$currencies->true_symbols = array( 'INR' => '₹' ) + $currencies->true_symbols;
	...
	public function source_text( $text, Payment $payment ) {
		$text = __( 'Events Manager Pro', 'pronamic_ideal' ) . '<br />';
	...
	public function source_description( $description, Payment $payment ) {
		return __( 'Events Manager Pro Booking', 'knit-pay' );
	}
