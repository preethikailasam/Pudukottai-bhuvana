...
class Extension extends AbstractPluginIntegration {
	...
	public function __construct() {
		parent::__construct(
			array(
				'name' => __( 'Paid Memberships Pro', 'pronamic_ideal' ),
			)
		);
	...
	public function setup() {
		...
		add_action( 'init', array( $gateway, 'init' ) );
	}
	...
	public function redirect_url( $url, $payment ) {
		...
		switch ( $payment->get_status() ) {
			...
			case Core_Statuses::OPEN:
				return add_query_arg( 'level', $morder->getMembershipLevel()->id, pmpro_url( 'checkout' ) );
				break;

			case Core_Statuses::SUCCESS:
				return add_query_arg( 'level', $morder->getMembershipLevel()->id, pmpro_url( 'confirmation' ) );
				break;
	...
	public function source_text( $text, Payment $payment ) {
		$text = __( 'Paid Memberships Pro', 'pronamic_ideal' ) . '<br />';
	...
	public function source_description( $description, Payment $payment ) {
		return __( 'Paid Memberships Pro Order', 'pronamic_ideal' );
	}
